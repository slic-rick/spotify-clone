...
public class MediaSeekBar extends AppCompatSeekBar {
    ...
    private static final String TAG = "learn.MediaSeekBar";

    private MediaControllerCompat mMediaController;

    private ControllerCallback mControllerCallback;

    private boolean mIsTracking = false;                                                            // when the user starts sliding the seekbar ==true
    ...
    private OnSeekBarChangeListener mOnSeekBarChangeListener = new OnSeekBarChangeListener() {
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            mIsTracking = false;
            mMediaController.getTransportControls().seekTo(getProgress());                          // seeking to new position
    ...
    public final void setOnSeekBarChangeListener(OnSeekBarChangeListener l) {
        ...
        throw new UnsupportedOperationException("Cannot add listeners to a com.example.spotifylearn.MediaSeekBar");
    }
    ...
    public void setMediaController(final MediaControllerCompat mediaController) {
        ...
        // if the mMediaController is connected to the service
