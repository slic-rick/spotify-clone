...
import static util.Constants.LAST_ARTIST;
import static util.Constants.LAST_ARTIST_IMAGE;
import static util.Constants.LAST_CATEGORY;
import static util.Constants.MEDIA_QUEUE_POSITION;
import static util.Constants.NOW_PLAYING;
import static util.Constants.PLAYLIST_ID;
